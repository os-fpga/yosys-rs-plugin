...
select *
synth_rs -libmap -tech genesis -top BRAM_SDP_36x1024 -goal area -de 
opt_expr -undriven
opt_clean
stat
...
select *
synth_rs -libmap -tech genesis -top BRAM_SDP_32x1024 -goal area -de
opt_expr -undriven
opt_clean
stat
...
select *
synth_rs -libmap -tech genesis -top BRAM_SDP_18x2048 -goal area -de
opt_expr -undriven
opt_clean
stat
...
select *
synth_rs -libmap -tech genesis -top BRAM_SDP_16x2048 -goal area -de 
opt_expr -undriven
opt_clean
stat
...
select *
synth_rs -libmap -tech genesis -top BRAM_SDP_9x4096 -goal area -de
opt_expr -undriven
opt_clean
stat
...
select *
synth_rs -libmap -tech genesis -top BRAM_SDP_8x4096 -goal area -de 
opt_expr -undriven
opt_clean
stat
...
select *
synth_rs -libmap -tech genesis -top BRAM_SDP_4x8192 -goal area -de
opt_expr -undriven
opt_clean
stat
...
select *
synth_rs -libmap -tech genesis -top BRAM_SDP_2x16384 -goal area -de
opt_expr -undriven
opt_clean
stat
...
select *
synth_rs -libmap -tech genesis -top BRAM_SDP_1x32768 -goal area -de
opt_expr -undriven
opt_clean
stat
