...
select *
synth_rs -libmap -tech genesis -top BRAM_TDP_SPLIT_2x18x1024 -goal area -de
opt_expr -undriven
opt_clean
stat
...
select *
synth_rs -libmap -tech genesis -top BRAM_TDP_SPLIT_2x16x1024 -goal area -de
opt_expr -undriven
opt_clean
stat
...
select *
synth_rs -libmap -tech genesis -top BRAM_TDP_SPLIT_2x9x2048 -goal area -de
opt_expr -undriven
opt_clean
stat
...
select *
synth_rs -libmap -tech genesis -top BRAM_TDP_SPLIT_2x8x2048 -goal area -de
opt_expr -undriven
opt_clean
stat
...
select *
synth_rs -libmap -tech genesis -top BRAM_TDP_SPLIT_2x4x4096 -goal area -de
opt_expr -undriven
opt_clean
stat
...
select *
synth_rs -libmap -tech genesis -top BRAM_TDP_SPLIT_2x2x8192 -goal area -de
opt_expr -undriven
opt_clean
stat
...
select *
synth_rs -libmap -tech genesis -top BRAM_TDP_SPLIT_2x1x16384 -goal area -de
opt_expr -undriven
opt_clean
stat
