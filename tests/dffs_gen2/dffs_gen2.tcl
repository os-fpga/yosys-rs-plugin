...
yosys proc
equiv_opt -assert -async2sync -map +/rapidsilicon/genesis2/cells_sim.v synth_rs -tech genesis2 -goal area -de -top my_dff
design -load postopt
yosys cd my_dff
stat
...
# DFFR (posedge RST)
yosys read -vlog2k $::env(DESIGN_TOP).v
synth_rs -tech genesis2 -goal area -de -top my_dffr_p
yosys cd my_dffr_p
stat
...
# DFFR (posedge RST)
yosys read -vlog2k $::env(DESIGN_TOP).v
synth_rs -tech genesis2 -goal area -de -top my_dffr_p_2
...
# DFFR (negedge RST)
yosys read -vlog2k $::env(DESIGN_TOP).v
synth_rs -tech genesis2 -goal area -de -top my_dffr_n
yosys cd my_dffr_n
stat
select -assert-count 1 t:dffr
...
#DFFRE (posedge RST)
yosys read -vlog2k $::env(DESIGN_TOP).v
synth_rs -tech genesis2 -goal area -de -top my_dffre_p
yosys cd my_dffre_p
stat
...
#DFFRE (negedge RST)
yosys read -vlog2k $::env(DESIGN_TOP).v
synth_rs -tech genesis2 -goal area -de -top my_dffre_n
yosys cd my_dffre_n
stat
select -assert-count 1 t:dffre
select -assert-count 1 t:\$lut
...
# DFFS (posedge SET)
yosys read -vlog2k $::env(DESIGN_TOP).v
synth_rs -tech genesis2 -goal area -de -top my_dffs_p
yosys cd my_dffs_p
stat
select -assert-count 1 t:dffr
...
# DFFS (negedge SET)
yosys read -vlog2k $::env(DESIGN_TOP).v
synth_rs -tech genesis2 -goal area -de -top my_dffs_n
yosys cd my_dffs_n
stat
select -assert-count 1 t:dffr
...
# DFFSE (posedge SET)
yosys read -vlog2k $::env(DESIGN_TOP).v
synth_rs -tech genesis2 -goal area -de -top my_dffse_p
yosys cd my_dffse_p
stat
select -assert-count 1 t:dffre
select -assert-count 2 t:\$lut
...
# DFFSE (negedge SET)
yosys read -vlog2k $::env(DESIGN_TOP).v
synth_rs -tech genesis2 -goal area -de -top my_dffse_n
yosys cd my_dffse_n
stat
select -assert-count 1 t:dffre
select -assert-count 3 t:\$lut
...
# DFFN
yosys read -vlog2k $::env(DESIGN_TOP).v
synth_rs -tech genesis2 -goal area -de -top my_dffn
yosys cd my_dffn
stat
...
yosys read -vlog2k $::env(DESIGN_TOP).v
synth_rs -tech genesis2 -goal area -de -top my_dffnr_p
yosys cd my_dffnr_p
stat
...
yosys read -vlog2k $::env(DESIGN_TOP).v
synth_rs -tech genesis2 -goal area -de -top my_dffnr_n
yosys cd my_dffnr_n
stat
select -assert-count 1 t:dffnr
select -assert-count 1 t:\$lut
...
yosys read -vlog2k $::env(DESIGN_TOP).v
synth_rs -tech genesis2 -goal area -de -top my_dffns_p
yosys cd my_dffns_p
stat
select -assert-count 1 t:dffnr
select -assert-count 2 t:\$lut
...
yosys read -vlog2k $::env(DESIGN_TOP).v
synth_rs -tech genesis2 -goal area -de -top my_dffns_n
yosys cd my_dffns_n
stat
select -assert-count 1 t:dffnr
select -assert-count 3 t:\$lut
...
yosys read -vlog2k $::env(DESIGN_TOP).v
synth_rs -tech genesis2 -goal area -de -top my_dffsr_ppp
...
yosys read -vlog2k $::env(DESIGN_TOP).v
synth_rs -tech genesis2 -goal area -de -top my_dffsr_ppn
...
yosys read -vlog2k $::env(DESIGN_TOP).v
synth_rs -tech genesis2 -goal area -de -top my_dffsr_npp
...
yosys read -vlog2k $::env(DESIGN_TOP).v
synth_rs -tech genesis2 -goal area -de -top my_dffsr_npn
