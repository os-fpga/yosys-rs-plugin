...
select *
synth_rs -libmap -tech genesis -goal area -de -top BRAM_TDP_36x1024
opt_expr -undriven
opt_clean
stat
...
select *
synth_rs -libmap -tech genesis -goal area -de -top BRAM_TDP_32x1024
opt_expr -undriven
opt_clean
stat
...
select *
synth_rs -libmap -tech genesis -goal area -de -top BRAM_TDP_18x2048
opt_expr -undriven
opt_clean
stat
...
select *
synth_rs -libmap -tech genesis -goal area -de -top BRAM_TDP_16x2048
opt_expr -undriven
opt_clean
stat
...
select *
synth_rs -libmap -tech genesis -goal area -de -top BRAM_TDP_9x4096
opt_expr -undriven
opt_clean
stat
...
select *
synth_rs -libmap -tech genesis -goal area -de -top BRAM_TDP_8x4096
opt_expr -undriven
opt_clean
stat
...
select *
synth_rs -libmap -tech genesis -goal area -de -top BRAM_TDP_4x8192
opt_expr -undriven
opt_clean
stat
...
select *
synth_rs -libmap -tech genesis -goal area -de -top BRAM_TDP_2x16384
opt_expr -undriven
opt_clean
stat
...
select *
synth_rs -libmap -tech genesis -goal area -de -top BRAM_TDP_1x32768
opt_expr -undriven
opt_clean
stat
