...
module \$__RS_FACTOR_BRAM36_TDP (...);
	...
	assign A_ADDR = PORT_C_RD_EN ? PORT_C_ADDR : (PORT_B_WR_EN ? PORT_B_ADDR : 15'd0);
	assign B_ADDR = PORT_A_RD_EN ? PORT_A_ADDR : (PORT_D_WR_EN ? PORT_D_ADDR : 15'd0);
	...
	RS_TDP36K #(
		...
		.RDATA_A1(C1DATA_TOTAL[17:0]),
		.RDATA_A2(C1DATA_TOTAL[35:18]),
		.ADDR_A1(A_ADDR),
		.ADDR_A2(A_ADDR),
		.CLK_A1(PORT_C_CLK),
		.CLK_A2(PORT_C_CLK),
		...
		.RDATA_B1(A1DATA_TOTAL[17:0]),
		.RDATA_B2(A1DATA_TOTAL[35:18]),
		.ADDR_B1(B_ADDR),
		.ADDR_B2(B_ADDR),
		.CLK_B1(PORT_A_CLK),
		.CLK_B2(PORT_A_CLK),
