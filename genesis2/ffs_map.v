...
// tech map between generic yosys DFF and genesis2 DFFs
//
//    <model name="dff">
//    <model name="dffn">
//    <model name="dffe">
...
module  \$_DFFE_PP_ (D, C, E, Q);
    ...
    dffre _TECHMAP_REPLACE_ (.Q(Q), .D(D), .C(C), .E(E), .R(1'b0));
endmodule
...
// Not done for GEMINI2 when both async set and reset are used
//
// Async set & reset
...
module \$_DFF_N_ (D, C, Q);
    ...
    dffnre _TECHMAP_REPLACE_ (.Q(Q), .D(D), .C(C), .E(1'b1), .R(1'b0));
endmodule
...
module  \$_DFFE_NP_ (D, C, E, Q);
    ...
    dffnre _TECHMAP_REPLACE_ (.Q(Q), .D(D), .C(C), .E(E), .R(1'b0));
endmodule
...
// Do not support yet both async set/reset for Gemini2
/*
...
/* Do not support SHREG_DFF for Gemini2
...
module \$_DLATCH_P_ (D, E, Q);
    ...
    latchr _TECHMAP_REPLACE_ (.Q(Q), .D(D), .G(E), .R(1'b0));
endmodule
...
module \$_DLATCH_N_ (D, E, Q);
    ...
    latchnr _TECHMAP_REPLACE_ (.Q(Q), .D(D), .G(E), .R(1'b0));
endmodule
