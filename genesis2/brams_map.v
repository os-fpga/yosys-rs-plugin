...
module \$__RS_FACTOR_BRAM36_TDP (A1ADDR, A1DATA, A1EN, B1ADDR, B1DATA, B1EN, C1ADDR, C1DATA, C1EN, CLK1, CLK2, D1ADDR, D1DATA, D1EN);
...
module \$__RS_FACTOR_BRAM18_TDP (A1ADDR, A1DATA, A1EN, B1ADDR, B1DATA, B1EN, C1ADDR, C1DATA, C1EN, CLK1, CLK2, CLK3, CLK4, D1ADDR, D1DATA, D1EN);
...
module \$__RS_FACTOR_BRAM18_SDP (A1ADDR, A1DATA, A1EN, B1ADDR, B1DATA, B1EN, CLK1, CLK2);
	parameter CFG_ABITS = 11;
	parameter CFG_DBITS = 18;
	parameter CFG_ENABLE_B = 4;
...
module \$__RS_FACTOR_BRAM36_SDP (CLK2, CLK3, A1ADDR, A1DATA, A1EN, B1ADDR, B1DATA, B1EN);
	parameter CFG_ABITS = 10;
	parameter CFG_DBITS = 36;
	parameter CFG_ENABLE_B = 4;
...
module \$__RS_FACTOR_BRAM36_SDP_ASYMMETRIC (RD_ADDR, RD_ARST, RD_CLK, RD_DATA, RD_EN, RD_SRST, WR_ADDR, WR_CLK, WR_DATA, WR_EN);
	parameter CFG_ABITS = 10;
	parameter CFG_DBITS = 36;
	parameter CFG_ENABLE_B = 4;
	...
	RS_TDP36K #(
		...
		.WDATA_B1(),
		.RDATA_B1(PORT_A1_RDATA),
		.ADDR_B1(RD_ADDR_SHIFTED),
		.CLK_B1(PORT_A1_CLK),
		.REN_B1(PORT_A1_REN),
		.WEN_B1(1'b0),
		.BE_B1(PORT_A1_BE),
		...
		.WDATA_B2(),
		.RDATA_B2(PORT_A2_RDATA),
		.ADDR_B2(RD_ADDR_SHIFTED),
		.CLK_B2(PORT_A2_CLK),
		.REN_B2(PORT_A2_REN),
		.WEN_B2(1'b0),
		.BE_B2(PORT_A2_BE),
