...
struct RSDspSimdPass : public Pass {

    RSDspSimdPass() : Pass("rs_dsp_simd", "Infers RapidSilicon k6n10f DSP pairs that can operate in SIMD mode") {}

    void help() override
    {
        log("\n");
        log("    rs_dsp_simd [selection]\n");
        log("\n");
    ...
    // For RS_DSP2 expand with configuration ports
    ...
    const std::string m_SimdDspType_cfg_ports = "RS_DSP2";
    const std::string m_SimdDspType_cfg_params = "RS_DSP3";
