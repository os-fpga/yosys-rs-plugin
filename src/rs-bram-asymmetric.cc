...
#include "../pmgen/rs-bram-asymmetric-wider-read.h"
#include "../pmgen/rs-bram-asymmetric-wider-write.h"

void test_rs_bram_asymmetric_wider_read(rs_bram_asymmetric_wider_read_pm &pm)
{
    auto mem = pm.st_rs_bram_asymmetric_wider_read.mem;
    auto mem_wr_addr = pm.st_rs_bram_asymmetric_wider_read.mem_wr_addr;
    auto mem_rd_data = pm.st_rs_bram_asymmetric_wider_read.mem_rd_data;
    auto mem_rd_addr = pm.st_rs_bram_asymmetric_wider_read.mem_rd_addr;
    auto mux = pm.st_rs_bram_asymmetric_wider_read.mux;
    auto mux_s = pm.st_rs_bram_asymmetric_wider_read.mux_s;
    auto wr_en_shift = pm.st_rs_bram_asymmetric_wider_read.wr_en_shift;
    auto wr_en_shift_b = pm.st_rs_bram_asymmetric_wider_read.wr_en_shift_b;
    auto wr_data_shift = pm.st_rs_bram_asymmetric_wider_read.wr_data_shift;
    auto wr_data_shift_a = pm.st_rs_bram_asymmetric_wider_read.wr_data_shift_a;
    auto wr_data_shift_b = pm.st_rs_bram_asymmetric_wider_read.wr_data_shift_b;
    auto wr_en_and = pm.st_rs_bram_asymmetric_wider_read.wr_en_and;
    auto wr_en_and_a = pm.st_rs_bram_asymmetric_wider_read.wr_en_and_a;
    auto wr_en_and_b = pm.st_rs_bram_asymmetric_wider_read.wr_en_and_b;
    auto wr_en_and_y = pm.st_rs_bram_asymmetric_wider_read.wr_en_and_y;
...
void test_rs_bram_asymmetric_wider_write(rs_bram_asymmetric_wider_write_pm &pm)
{
    ...
    auto mem_rd_data = pm.st_rs_bram_asymmetric_wider_write.mem_rd_data;
    auto mem_rd_addr = pm.st_rs_bram_asymmetric_wider_write.mem_rd_addr;
    auto rd_data_shift = pm.st_rs_bram_asymmetric_wider_write.rd_data_shift;
    auto rd_data_shift_y = pm.st_rs_bram_asymmetric_wider_write.rd_data_shift_y;
    auto rd_data_ff = pm.st_rs_bram_asymmetric_wider_write.rd_data_ff;
    auto rd_data_ff_q = pm.st_rs_bram_asymmetric_wider_write.rd_data_ff_q;
    auto rd_data_ff_en = pm.st_rs_bram_asymmetric_wider_write.rd_data_ff_en;
    auto rd_data_ff_clk = pm.st_rs_bram_asymmetric_wider_write.rd_data_ff_clk;
    auto wr_addr_ff = pm.st_rs_bram_asymmetric_wider_write.wr_addr_ff;
    auto wr_addr_ff_d = pm.st_rs_bram_asymmetric_wider_write.wr_addr_ff_d;
    auto wr_en_mux = pm.st_rs_bram_asymmetric_wider_write.wr_en_mux;
    auto wr_en_mux_s = pm.st_rs_bram_asymmetric_wider_write.wr_en_mux_s;
    auto rd_addr_and = pm.st_rs_bram_asymmetric_wider_write.rd_addr_and;
    auto rd_addr_and_a = pm.st_rs_bram_asymmetric_wider_write.rd_addr_and_a;
    auto rd_addr_and_b = pm.st_rs_bram_asymmetric_wider_write.rd_addr_and_b;
...
struct RSBramAsymmetric : public Pass {

    RSBramAsymmetric()
        : Pass("rs_bram_asymmetric",
    ...
    {
        log_header(a_Design, "Executing RS_BRAM_ASYMMETRIC pass.\n");
